...
# Load data
#train_dataset, val_dataset, test_dataset, input_size, target_size, song_ids = get_dataset_multi_hot(choice= dataset, val_split=0.1, test_split=0.1, seed=42, get_song_ids=True)
